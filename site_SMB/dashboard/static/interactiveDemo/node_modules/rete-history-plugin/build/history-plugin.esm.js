...
function (_Action) {
  ...
  function NodeAction(editor, node) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(NodeAction).call(this));
    _this.editor = editor;
    _this.node = node;
    return _this;
  }
...
var AddNodeAction =
/*#__PURE__*/
function (_NodeAction) {
  _inherits(AddNodeAction, _NodeAction);

  function AddNodeAction() {
    _classCallCheck(this, AddNodeAction);

    return _possibleConstructorReturn(this, _getPrototypeOf(AddNodeAction).apply(this, arguments));
  }
...
/*#__PURE__*/
function (_NodeAction2) {
  _inherits(RemoveNodeAction, _NodeAction2);

  function RemoveNodeAction() {
    _classCallCheck(this, RemoveNodeAction);

    return _possibleConstructorReturn(this, _getPrototypeOf(RemoveNodeAction).apply(this, arguments));
  }
...
function (_NodeAction3) {
  ...
  function DragNodeAction(editor, node, prev) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(DragNodeAction).call(this, editor, node));
